  ...
  const handleDeleteBook = async () => {
    if (window.confirm("Are you sure you want to delete this book?")) {
      try {
        ...
        onDeleteBook(book._id); // Pass book ID for deletion handling in parent component
      } catch (err) {
        ...
        <div className="book-details-info">
          {isEditing ? (
            <>
              ...
              <input type="text" name="authors" value={editedBook.authors} onChange={handleChange} />
            ...
            <>
              ...
              <p>
                <strong style={{ color: "green" }}>Authors:</strong> {book.authors}
              </p>
              <p>
